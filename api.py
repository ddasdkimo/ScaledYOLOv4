...
# personPart = ApiDetect(cfg="run_weights/person_part/person_part-yolov4-csp_416.cfg", imgsesize=640,weights="run_weights/person_part/best_person_part.pt",names="run_weights/person_part/person_part.name")#coco 辨識
...
raiAi = ApiDetect(cfg="/home/ubuntu/YOLOv4-CSP/traindata/rai_check_630/rai_check_630-yolov4-csp_416.cfg", imgsesize=640,weights="/home/ubuntu/YOLOv4-CSP/yolov4-csp/runs/exp67_rai_check_630/weights/best.pt",names="/home/ubuntu/YOLOv4-CSP/traindata/rai_check_630/rai_check_630.name")#rai 主要辨識核心
...
def userPhoto():
    ...
    raiAiStr = raiAi.detect(filename)
    remystr = []
    yolostr = ""
    for item in mystr:
